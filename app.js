...
const A = {
  ...
  payBill(id){
    ...
    const body='<div style="text-align:center;padding:4px 0 14px">'
      ...
      +'<img src="'+qrUrl+'" alt="UPI QR" style="width:180px;height:180px;border-radius:12px;border:3px solid var(--acc);background:#fff;padding:4px"><br>'
      +'<div style="margin-top:10px;font-size:.875rem;color:var(--txt2)">Tap <strong>Open UPI App</strong> to pay directly, or scan QR</div>'
      ...
      +'<div style="margin-bottom:10px;padding:10px;background:rgba(255,181,71,.08);border:1px solid rgba(255,181,71,.3);border-radius:8px;font-size:.8rem;color:var(--warn)">After paying, enter UTR below for admin verification.</div>'
    ...
    const foot='<button class="btn btn-s" onclick="A.closeModal()">Cancel</button>'
      +'<a href="'+upiUrl+'" class="btn btn-p" style="text-decoration:none;background:linear-gradient(135deg,#00D48E,#1a73e8)" onclick="setTimeout(()=>A.toast(\'No UPI app? Copy the UPI ID and open GPay/PhonePe manually\',\'warn\'),2000)"><span class="material-icons-round">open_in_new</span>Open UPI App</a>'
