...
const A = {
  ...
  payBill(id){
    ...
    const body='<div style="text-align:center;padding:4px 0 10px">'
      ...
      +'<div style="margin:10px 0 8px;font-size:.85rem;color:var(--txt2)">Tap <strong style="color:var(--txt)">Open UPI App</strong> below to pay directly</div>'
      +'<a href="'+upiUrl+'" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;background:linear-gradient(135deg,#00D48E,#1a73e8);color:#fff;font-weight:700;padding:12px 28px;border-radius:10px;font-size:.95rem;margin-bottom:12px;box-shadow:0 4px 18px rgba(0,180,120,.35)">'
      +'<span class="material-icons-round">open_in_new</span>Open UPI App</a>'
